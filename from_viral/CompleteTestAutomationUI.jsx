...
import { ChevronRight, ChevronDown, Folder, FolderOpen, File, Plus, Search, MoreVertical, Play, Edit, Trash2, Copy, FolderPlus, Upload, Download, Filter, Grid, List, Clock, CheckCircle, XCircle, AlertCircle, Zap, ArrowRight, ArrowDown, X, Sparkles, Wand2, Save, Eye, ChevronUp, PlusCircle, Trash, Move, GripVertical } from 'lucide-react';
...
const STEP_TYPES = [
  ...
  { id: 'action', label: 'Action', icon: '➕', color: 'slate', description: 'Click, type, or interact' },
    ...
    <div className="h-screen bg-slate-50 flex overflow-hidden">
      <style>{`
        ...
        * {
        ...
        .flow-step:hover .step-hover-actions {
          opacity: 1;
        }
      `}</style>
...
function TestBuilderModal({ onClose }) {
  ...
  const [showAddStepModal, setShowAddStepModal] = useState(null); // { position: 'before' | 'after', stepId: number }
    ...
    <div className="flow-step relative group">
      ...
      <div className={`${colorClasses[step.color]} border-2 rounded-xl p-5 shadow-sm hover:shadow-lg transition-all relative`}>
        ...
        <div className="flex items-center gap-4">
          ...
          {/* Action Buttons */}
          <div className="flex flex-col gap-1 step-hover-actions">
